        ...
        <div class="p-4 grid grid-cols-2 gap-3 overflow-y-auto">
            {#each SHAPES as shape}
                ...
                >
                    ...
                    >
                    <span
                        class="text-xs font-semibold text-gray-500 group-hover:text-blue-600"
                        >{shape.label}</span
                    >
                </button>
            {/each}
            ...
            >
                {#if data.shapeType === "rectangle"}
                    <rect
                        ...
                        stroke-width={data.borderThickness}
                        rx="4"
                ...
                {:else if data.shapeType === "triangle"}
                    <polygon
                        points={`${data.width / 2},0 0,${data.height} ${data.width},${data.height}`}
                        fill={data.fillColor}
                        stroke={data.borderColor}
                        stroke-width={data.borderThickness}
                ...
                {:else if data.shapeType === "star"}
                    <polygon
                        points={`${data.width * 0.5},0 ${data.width * 0.63},${data.height * 0.38} ${data.width},${data.height * 0.38} ${data.width * 0.69},${data.height * 0.59} ${data.width * 0.82},${data.height} ${data.width * 0.5},${data.height * 0.75} ${data.width * 0.18},${data.height} ${data.width * 0.31},${data.height * 0.59} 0,${data.height * 0.38} ${data.width * 0.37},${data.height * 0.38}`}
                        fill={data.fillColor}
                        stroke={data.borderColor}
                        stroke-width={data.borderThickness}
                        stroke-linejoin="round"
                ...
                {:else if data.shapeType === "heart"}
                    <path
                        d={`M${data.width / 2},${data.height * 0.3} C${data.width / 2},${data.height * 0.1} ${data.width * 0.2},${data.height * 0.1} ${data.width * 0.2},${data.height * 0.4} C${data.width * 0.2},${data.height * 0.6} ${data.width / 2},${data.height * 0.9} ${data.width / 2},${data.height * 0.9} C${data.width / 2},${data.height * 0.9} ${data.width * 0.8},${data.height * 0.6} ${data.width * 0.8},${data.height * 0.4} C${data.width * 0.8},${data.height * 0.1} ${data.width / 2},${data.height * 0.1} ${data.width / 2},${data.height * 0.3}`}
                        fill={data.fillColor}
                        stroke={data.borderColor}
                        stroke-width={data.borderThickness}
                        vector-effect="non-scaling-stroke"
                ...
                {:else if data.shapeType === "bubble"}
                    <path
                        d={`M0,0 h${data.width} v${data.height * 0.8} h-${data.width * 0.4} l-${data.width * 0.1},${data.height * 0.2} l-${data.width * 0.1},-${data.height * 0.2} h-${data.width * 0.4} z`}
                        fill={data.fillColor}
                        stroke={data.borderColor}
                        stroke-width={data.borderThickness}
                        vector-effect="non-scaling-stroke"
